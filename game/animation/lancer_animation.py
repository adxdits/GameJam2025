...
SCREEN_WIDTH = 800
SCREEN_HEIGHT = 600
SCREEN_TITLE = "Lancer Walking Animation"
    ...
    def update_animation(self):
        ...
        if is_moving or self.auto_animate:
            ...
            if self.animation_timer >= ANIMATION_SPEED:
                ...
                self.player_sprite.texture = self.walking_textures[self.current_texture]
        else:
            # Player is not moving and auto-animate is off, show first frame
            self.current_texture = 0
            self.player_sprite.texture = self.walking_textures[0]
